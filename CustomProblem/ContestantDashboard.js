...
import { Profile, Blog, Submissions, Contests } from '../utils/contestantDashboard';
import SettingsForm from './SettingsForm'; // import SettingsForm
...
const ContestantDashboard = () => {
    ...
    const renderActiveTab = () => {
        switch (activeTab) {
            ...
            case 'settings':
                return <SettingsForm />; // render SettingsForm
            case 'blog':
                return <Blog />;
            case 'submissions':
