...
// Logic for getting all custom problems
const getAllCustomProblems = async (req, res) => {
  try {
    const customProblems = await CustomProblem.find();
...
module.exports = { createCustomProblem, getCustomProblemById, getAllCustomProblems, updateCustomProblemById };
